...
import com.example.androiddevchallenge.HMSFontInfo.Companion.HMS
import com.example.androiddevchallenge.HMSFontInfo.Companion.MS
import com.example.androiddevchallenge.HMSFontInfo.Companion.S
...
private fun BoxScope.AnimationCircleCanvas(durationMills: Int) {
    ...
    val animateTween by animateFloatAsState(
        targetValue = trigger,
        animationSpec = tween(durationMillis = durationMills, easing = LinearEasing),
        finishedListener = {
            isFinished = true
        }
    )
    ...
    Canvas(
        ...
        val topLeftOffset = Offset(0f, 30f)
...
private data class HMSFontInfo(val fontSize: TextUnit, val labSize: TextUnit, val padding: Dp) {
    companion object {
